...
% ---------- Encoding / language / fonts (XeLaTeX) ----------
\usepackage{fontspec}
...
% ---------- Quotation marks ----------
% \enquote{...} typesets English "..."; autostyle follows the polyglossia language.
\usepackage[autostyle=true]{csquotes}

% ---------- Geometry ----------
\usepackage[a4paper,margin=1.8cm,headheight=14pt]{geometry}

% ---------- Colour palette (same as the docx variant) ----------
...
% ---------- Document metadata (override in the individual .tex) ----------
\newcommand{\doctitle}{AI-Assisted Development — Rules for Projects}
\newcommand{\docsubject}{Policy template + best practices}
\newcommand{\docclass}{Public template — CC-BY 4.0}
...
\fancyhead[L]{\sffamily\footnotesize\color{black!45}\doctitle}
\fancyfoot[C]{\sffamily\footnotesize\color{black!45}\docclass{} — \versionline \quad Page \thepage{} of \pageref{LastPage}}
...
% blast-radius cell: \br{colour}{text}
...
% ---------- Document version (injected by CI) ----------
% CI generates version.tex with \def\docversion / \doccommit / \docdate.
% A local build without version.tex falls back to "draft".
...
% Version string for the footer and the title page
\newcommand{\versionline}{v\docversion\ (\doccommit) — \docdate}

% ---------- Typesetting: more tolerant line breaking ----------
\tolerance=1200
