...
\begin{callout}[amber]{Co pravidla vynucují a co ne}
Pravidla v~tomto dokumentu nevynucují úsudek; určují jen místa, kde je úsudek vyžadován, a kdo za něj nese odpovědnost.
Mechanika (gate na MR, \code{CODEOWNERS}, kontroly v~CI --- viz A5) je vynutitelná, ale sama o~sobě nestačí.
Jádrem jsou pravidla A1.1 a A1.2, tedy porozumění kódu a jeho převzetí jako vlastního --- a ta vynutit nelze, lze je jen vyžadovat v~review.
To je záměr, ne nedostatek: pravidla jsou psána s~úmyslem, aby odpovědnost zůstala na lidech a nepřesunula se na nástroj ani na proces.
Pro zavedení rámce z~toho plyne, že organizace, která převezme mechaniku bez převzetí odpovědnosti, si nevzala nic --- dostane zelené kontroly bez změny rozhodování.
Za nasazený je rámec zamýšlen teprve tehdy, když existuje konkrétní jmenovaná osoba ochotná zamítnout MR s~odkazem na A1.1 a má k~tomu krytí.
Pokud taková osoba není, rámec zatím nasazený není, ať je v~repozitáři cokoli.
\end{callout}
...
Bez doloženého právního základu pro přenos se nástroj nepoužije; posouzení základu patří roli, která za ochranu osobních údajů odpovídá.
\item \textbf{Data pod NDA a nedůvěryhodné AI nástroje.}
AI nástroj, který odesílá kód nebo data ke zpracování třetí straně, se pro účely této směrnice považuje za \emph{přenos dat třetí straně} --- bez ohledu na to, že nástroj nabízí volbu \enquote{neukládat} či \enquote{neučit se z~dat}.
...
\item \textbf{Konfigurace AI nástroje je součástí kódu.}
Soubory, které řídí chování AI nástroje (pravidla, systémové instrukce, konfigurace vývojového prostředí), podléhají stejnému review jako kód, který ovlivňují, a patří do soupisu rizikových cest dle A5.2.
AI je smí navrhnout, ale nesmí je zavést --- změna těchto souborů bez převzetí dle A1.2 je porušení směrnice.
Kontroluje se i to, co v~diffu není na první pohled vidět (neviditelné znaky, změna kódování).
Důvod: kdo změní pravidla, změní všechna pravidla najednou --- včetně těch, která mají tu změnu zachytit.
\end{enumerate}
